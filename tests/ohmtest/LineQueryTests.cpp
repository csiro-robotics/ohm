...
namespace linequerytests
{
  ...
  TEST(LineQuery, CpuVsGpuSimple)
  {
    ...
    LineQuery gpu_query(map, glm::dvec3(0) - glm::dvec3(map_res), glm::dvec3(0), 2.0f, kQfGpuEvaluate);
  ...
  TEST(LineQuery, CpuVsGpu)
  {
    ...
    LineQuery gpu_query(map, glm::dvec3(0), glm::dvec3(0), 2.0f, kQfGpuEvaluate);
