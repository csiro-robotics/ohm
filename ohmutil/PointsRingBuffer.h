...
{
public:
  inline PointsRingBuffer(size_t initial_capacity = 0) : PointsRingBufferT<float>(initial_capacity) {}
};
...
{
public:
  inline PointsRingBufferD(size_t initial_capacity = 0) : PointsRingBufferT<double>(initial_capacity) {}
};
