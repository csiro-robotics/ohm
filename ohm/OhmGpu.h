...
namespace ohm
{
  ...
  /// @return 0 on success.
  int ohm_API configureGpuFromArgs(int argc, const char **argv, bool show_device = true);

  /// @overload
  inline int ohm_API configureGpuFromArgs(int argc, char **argv, bool show_device = true)
  {
  ...
  /// @return 0 on success.
  int ohm_API configureGpu(unsigned accel = GpuAccel, const char *device_name = nullptr, bool show_device = true);
  ...
  /// - 1 : string
  ///
  /// @param args_info Populated with pairs of command line arguments and their descriptions up to @c maxPairs items. Null to query the
  ///     number of arguments.
