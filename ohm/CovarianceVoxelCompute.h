                                                     ...
                                                     unsigned reinitialise_sample_count)
{
  ...
  {
    const covreal delta = intensity->intensity_mean - intensity_sample;
    const float point_count_float = float(point_count), inv_point_count_plus_one = 1.0f / (point_count_float + 1.0f);
