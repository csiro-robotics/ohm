...
namespace ohm
{
  ...
  /// The implementation assumes that subsequent calls will have some spatial consistency, thus the default
  /// implementation cache simply tracks the last region used. Multiple regions may be tracked by defining @c
  /// OHM_MULTI_CACHE.
  ///
