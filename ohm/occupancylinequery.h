...
#ifndef OCCUPANCYLINEQUERY_H_
#define OCCUPANCYLINEQUERY_H_
...
namespace ohm
{
  ...
  public:
    ...
    static const unsigned DefaultFlags = QF_NoCache;
  ...
  public:
    ...
    /// @param searchRadius Defines the "width" of the line. See @c searchRadius().
    /// @param queryFlags Flags controlling the query behaviour. See @c QueryFlag and @c LineQuery::Flag.
    LineQuery(OccupancyMap &map, const glm::dvec3 &startPoint, const glm::dvec3 &endPoint, float searchRadius,
              unsigned queryFlags = DefaultFlags);
